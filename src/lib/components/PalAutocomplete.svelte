...
<div class="relative w-80">
	...
	{:else}
		<input
			...
			onblur={handleBlur}
			{placeholder}
			class="h-10 w-full rounded-md border border-neutral-700 bg-neutral-900 px-3 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-neutral-500"
		/>
	{/if}
