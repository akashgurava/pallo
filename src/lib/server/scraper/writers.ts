...
import type { parseDetailPage } from "./detail-parser";
import type { MountEntry } from "./mounts-parser";
import type { ParsedPassiveSkill } from "./passives-parser";
import type { BreedingEntry } from "./breeding-parser";
